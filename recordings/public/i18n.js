...
(function () {
  ...
  "ja": {
    ...
    "rec.footer.note": "録画は DVR (XVR) / ローカル録画から取得。LAN 内専用・インターネット非公開。",
    "rec.header.live.label": "ライブ視聴",
    "rec.header.live.title": "ライブ映像ビューアを開く",
    "rec.header.subtitle": "DVR (XVR) / LAN内専用",
  ...
  "en": {
    ...
    "rec.footer.note": "Recordings sourced from DVR (XVR) / local recording. LAN only, not exposed to the internet.",
    "rec.header.live.label": "Live View",
    "rec.header.live.title": "Open the live video viewer",
    "rec.header.subtitle": "DVR (XVR) / LAN only",
